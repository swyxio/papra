        ...
        def paragraph(p):
            ...
            for m in pattern.finditer(full):
                ...
                if token.startswith('_'):
                    ...
                    labels={'mutual-nda':['Effective date','Counterparty name','Discussion purpose','Company confidential information scope','Counterparty confidential information scope','Jurisdiction county','Company address line 1','Company address line 2','Company address line 3'], 'offer-letter':['Company address line 1','Company address line 2','Company address line 3','Greeting name','Primary duties','Starting compensation','Number of shares','Offer expiration date','Latest start date'], 'advisor-agreement':['Number of shares','Advisor term','Company address line 1','Company address line 2','Company address line 3','Company fax','Advisor address line 1','Advisor address line 2','Advisor address line 3','Advisor fax','Advisor email']}
                    if occurrence<=len(labels.get(item['id'],[])):label=labels[item['id']][occurrence-1]
